...
| « : » seul au bout d'une ligne, valeur à la ligne d'après | Corrigé à l'affichage : un script (après la mesure de `--sticky-stack-bottom`) colle chaque « mot : valeur » avec des espaces insécables sur tous les nœuds de texte (y compris ceux ajoutés plus tard) — pas besoin d'y penser en écrivant du HTML. |
